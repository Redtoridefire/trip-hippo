        ...
        {activeTab === "itinerary" ? (
          ...
          >
            <div className="space-y-6">
              ...
              {/* Empty state */}
              {days.length === 0 && (
                <div className="rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 p-8 text-center">
...
function UnscheduledDropzone({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <h3 className="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Unscheduled</h3>
      {children}
    </div>
  )
}
